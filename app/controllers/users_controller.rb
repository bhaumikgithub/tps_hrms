...
class UsersController < ApplicationController
  ...
  before_action :find_user, only: [:activation, :edit, :update, :destroy, :show, :change_profile, :remove_profile, :authenticate_user, :create_education_detail, :edit_education_detail_modal, :edit_user_designation_modal, :edit_user_tracker_modal, :delete_education, :delete_designation,:delete_tracker, :generate_designation_pdf, :edit_resign_model, :withdraw_resignation, :create_work_history, :edit_user_work_history, :delete_user_work_history]
